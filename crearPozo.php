            ...
            <form class="col s12" action="creandoPozo.php" method="post">
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label class="orange-text text-darken-4" for="input_text">Nombre del pozo:</label>
                    </div>
                </div>
                
                <button class="btn waves-effect waves-light orange darken-4" type="submit" name="action">Añadir pozo</button>
            </form>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col l6 s12">
                    ...
                    <h5 class="white-text">Calculo de manómetros</h5>
