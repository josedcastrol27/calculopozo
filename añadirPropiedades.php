...
<body>
    ...
    <nav class="nav-wrapper orange darken-3">
        <div class="container">
            ...
            <form class="col s12" action="agregando.php" method="post">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label class="orange-text text-darken-4" for="input_text">Medición:</label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label class="Orange-text text-darken-4" for="input_text">Fecha:</label>
                        <?php echo 'Escribir la fecha en el siguiente formato: '. date('Y-m-d');?>
                    </div>
                </div>
                
                <button class="btn waves-effect waves - Orange darken-4" type="submit" name="action" value="si">Agregar</button>
            </form>
        </div>
    </div>
